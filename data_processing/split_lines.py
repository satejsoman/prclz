...
if __name__ == '__main__':
    ...
    # Make file paths
    if not os.path.isdir(os.path.join(DATA_PATH, "lines", args.region)):
        os.mkdir(os.path.join(DATA_PATH, "lines", args.region))
    if not os.path.isdir(os.path.join(DATA_PATH, "lines", args.region, args.country_code)):
        os.mkdir(os.path.join(DATA_PATH, "lines", args.region, args.country_code))
