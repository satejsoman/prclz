...
< prclz/parcelization/midway_parcelization.sbatch sed -e "s/::COUNTRYCODE::/${countrycode}/g" -e "s/::COUNTRYNAME::/${countryname}/g" > prclz/parcelization/filled_templates/${countrycode}_parcels.sbatch
